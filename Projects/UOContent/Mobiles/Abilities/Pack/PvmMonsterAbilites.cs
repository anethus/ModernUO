...
namespace Server.Custom.PvM
{
    ...
    public partial class PvmMonsterAbilities
    {
        ...
        public static bool IsPointInTrapezoid(Point2D p, Point2D a, Point2D b, Point2D c, Point2D d)
        {
            ...
            double cp1 = CrossProduct(Subtract(b, a), Subtract(p, a));
            double cp2 = CrossProduct(Subtract(c, b), Subtract(p, b));
            double cp3 = CrossProduct(Subtract(d, c), Subtract(p, c));
            double cp4 = CrossProduct(Subtract(a, d), Subtract(p, d));
